...
3. Voice names the sequence, then on the lunge–lever–handstand–lunge runs it says **side view, stand clean, stay clean until we start**. Then the class script (feet together / passé 3-2 / fall to lunge 3-2 / lever 3-2 / handstand / landing lunge 5-count / clean). **Start sequence** jumps the live camera to **full screen** so you can get set. You can also tap **Full screen first** and start from the camera. The still switches to the shape being named.

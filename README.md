...
- **Delay cam** — adjustable **6–20s** delay (MediaRecorder timeslice chunks fed into a MediaSource buffer playing behind live). Safari on iPhone uses **ManagedMediaSource** when classic MediaSource is missing. Android Chrome keeps the classic path. Needs a shared recorder/player codec.

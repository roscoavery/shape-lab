...
- **Library play** — Instagram Reels are the fast path (cached blob, then stream while resolve races HTML vs Cobalt). TikTok uses the same helper. YouTube plays in an embed, not a raw `<video>` tag.

...
- **Gym desks** — every profile defaults to **Tumble Smart Athletics**. A coach’s Today list is that gym plus athletes who take class there or who they do privates with. Camp / clinic groups stay off the main desk. **Search all** or pick another gym to find anyone; other-gym names are labeled. Network still connects everyone.

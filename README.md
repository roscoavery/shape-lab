...
- **Library play** — Instagram Reels download into the app and, once they play, Shape Lab keeps a gym copy so the next phone does not need Instagram again. YouTube plays in an embed, not a raw `<video>` tag.

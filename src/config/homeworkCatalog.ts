...
export const HOMEWORK_CATALOG: HomeworkCatalogItem[] = [
  ...
  },
  {
    ...
    audience: 'class',
    targetReps: 12,
    notes: 'Slow up, slow down. Bent-knee or single-leg left/right are optional specs.',
    cues: [
      'Full range if the ankle allows it.',
      'Pause at the top of a quality rep.',
    ],
  },
  {
    ...
    audience: 'class',
    targetReps: 5,
    notes: 'Lower with control. Catch with the hands if you cannot pull back up yet.',
    cues: [
      'Hips stay long. Do not pike to cheat the lower.',
      'A quality rep is a slow lower you could stop.',
    ],
  },
  {
    id: 'slantboard_squat',
    name: 'Slantboard squats',
    trackMode: 'reps',
    audience: 'class',
    targetReps: 8,
    ...
    cues: [
      'Chest stays tall.',
      'Let the knees go forward over the toes.',
    ],
  },
  {
    id: 'poliquin_step',
    ...
    targetReps: 8,
    notes:
      'Elevated heel, reverse step-up pattern. Specs: two legs, or add assistance. None selected by default.',
    cues: [
      'Working knee tracks over the toes.',
      'Control the lower. Do not drop onto the back foot.',
    ],
  },
  {
    id: 'tib_raise',
    ...
    audience: 'class',
    targetReps: 15,
    notes: 'Heels planted, pull the toes toward the shins. Slow. Quality over count.',
    cues: [

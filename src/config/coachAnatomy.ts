...
export const ANATOMY_LESSONS: CoachLesson[] = [
  {
    ...
    body: [
      ...
      'Wrist flexion points the palm toward the forearm. Wrist extension is the opposite. The handstand block lives in wrist extension. Ulnar and radial deviation are the small side to side wrist motions.',
      'Ankle plantarflexion is a pointed foot and the push of a punch. Dorsiflexion draws the toes toward the shin. That is the landing and the hurdle. Forced extra dorsiflexion on a short landing is where many ankles get hurt.',

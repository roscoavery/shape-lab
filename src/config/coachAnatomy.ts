...
export const ANATOMY_LESSONS: CoachLesson[] = [
  {
    ...
    body: [
      'Flexion closes a joint. Extension opens it. Coaches already cue this without the words: “close the hips” on a hollow is hip flexion; “open the hips” on a handstand is hip extension. Shoulder flexion is arms traveling toward overhead — by the ears. That is the high V, the handstand line, Superman, and the arch: those shapes are shoulder flexion, not extension, even when the chest is up. Shoulder extension is arms down and back (the opposite of overhead). If you cue “arms by the ears” you are asking for shoulder flexion plus the scapulae to let that happen.',
      'Elbows and knees: flexion is bend, extension is straight. Cue “straighten the elbows” or “finish the elbows,” not “lock the elbows.” A lock dump on a kid who already hyperextends sends the joint past straight into a reverse curve. Soft knees is a little flexion. Wrist: flexion is palm toward the forearm, extension is the opposite (the handstand block lives here). Ulnar and radial deviation are the small side-to-side wrist motions. Ankle: plantarflexion is pointed toes / the push of a punch. Dorsiflexion is toes toward the shin — the landing and the hurdle. Forced extra dorsiflexion on a short landing is where a lot of ankles get hurt.',
      ...
      'Pair the cue with the action. “Reach long” on a layout is hip extension and shoulder flexion (arms by the ears) with a long spine. “Get tight” is flexion at hips and knees plus arms in. “Block” is shoulder flexion and wrist extension into the floor. When a cue fails, ask which joint you actually meant.',
    ],
  ...
  },
  {
    ...
    gym: 'If elbows or knees hyperextend, cue a strong mid-range stop — not “lock.” Do not stretch that end-range for a prettier line. Film the wrist on blocks and the ankle on short landings.',
  },
  {
    id: 'tissues-grades',

 ...
 * (never Ryan's words), `answer` is Ryan verbatim from his 28
 * coach-interview answers (2026-09-25). The renderer styles questions
 * as prompts so they never read like something Ryan typed.
 * first-landing-parent is omitted — his answer pointed at another box.
 *
 * To refresh after he edits answers: re-run /tmp/build_parent_guide_qa.py
 */
...
export type ParentEducationQA = {
  ...
  question: string
  /** Ryan verbatim. Render as his words. */
  answer: string[]
}

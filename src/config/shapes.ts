...
export const SHAPES: ShapeDef[] = [
  ...
  // ===========================================================================
  {
    ...
    criteria: [
      ...
      },
      {
        ...
        falloff: 50,
        weight: 40,
        feedbackHigh: 'Arms down by your sides or in front.',
      },
      {
        id: 'standing',
        label: 'Standing',
  ...
  // ===========================================================================
  {
    ...
    criteria: [
      ...
      },
      {
        ...
        weight: 22,
        needsView: 'side',
        feedbackHigh: 'Tilt the chest a bit more toward the ground.',
      },
      {
        id: 'line_foot_hands',
      ...
      },
      {
        ...
        falloff: 65,
        weight: 12,
        feedbackLow: 'Reach arms by the ears as far as you can. Slightly closed is still a lever.',
      },
      {
        id: 'elbows',
        label: 'Elbows straight',
  ...
  // ===========================================================================
  // PIKE (ZOMBIE ARMS) — seated, torso upright hollow, arms covering ears.
  // Standing zombie is a different shape (zombie). This is the floor pike.
  // ===========================================================================
  {
    id: 'seated_pike',
    ...
    criteria: [
      ...
      {
        id: 'zombie_arms',
        label: 'Zombie arms / ears covered',
        kind: 'joint_angle',
        points: L_SHOULDER,
        targetMin: 60,
        targetMax: 120,
      ...
      },
      {
        ...
        falloff: 0.22,
        weight: 10,
        feedbackHigh: 'Shrug so the arms cover the ears.',
      },
      {
        id: 'eyes_through_hands',
        label: 'Eyes through the hands',
        kind: 'segment_vs_vertical',
        segment: [LM.LEFT_SHOULDER, LM.NOSE],
        targetMin: 8,
        targetMax: 50,
  ...
  // ===========================================================================
  {
    ...
    criteria: [
      ...
      },
      {
        ...
        tolerance: 18,
        weight: 10,
        feedbackLow: 'Straighten the knees if the lower back is already flat.',
      },
      {
        id: 'elbows',
        label: 'Elbows straight',
  ...
  // ===========================================================================
  {
    ...
    tips: [
      ...
      'Start in a zombie-arm pike and inch back until the lowest part of the lower back touches.',
    ...
    criteria: [
      ...
      },
      {
        ...
        tolerance: 28,
        weight: 4,
        feedbackLow: 'Straighten the knees if the lower back is already flat. Bent knees are OK to get the back down.',
      },
      {
  ...
  // ===========================================================================
  // TIGHT ARCH — supine arch (on the back). Snap-open / pike–hollow–arch finish.
  // ===========================================================================
  {
    id: 'arch',
    name: 'Tight arch',
    ...
    coachNotes:
      'Commonly called tight arch. Used at the end of pike → hollow → arch and the snap-open drill. Arms press the floor behind the ears. Hips come up; knees stay locked. Athletes commonly struggle to keep the ankles together with the toes pointed.',
    criteria: [
      {
        id: 'hip_extension',
        label: 'Hips up / tight arch',
        kind: 'joint_angle',
        points: L_HIP,
        targetMin: 160,
        targetMax: 200,
        ...
        falloff: 45,
        weight: 26,
        feedbackLow: 'Push the hips up off the floor.',
      },
      {
        id: 'shoulders',
        label: 'Arms behind the ears',
        kind: 'joint_angle',
        points: L_SHOULDER,
        targetMin: 140,
        targetMax: 180,
        tolerance: 12,
        weight: 18,
        feedbackLow: 'Press the arms against the floor behind the ears.',
      },
      {
        id: 'knees',
        label: 'Knees straight',
        ...
        tolerance: 10,
        weight: 20,
        feedbackLow: 'Straighten the knees.',
      },
      {
        id: 'ankles_together',
        label: 'Ankles together',
        kind: 'point_distance',
        pair: [LM.LEFT_ANKLE, LM.RIGHT_ANKLE],
        target: 0,
        tolerance: 0.06,
        falloff: 0.18,
        weight: 18,
        feedbackHigh: 'Squeeze the ankles together.',
      },
      {
        id: 'toes',
        label: 'Toes pointed',
  ...
  // ===========================================================================
  // TUCKED CANDLE — seated tuck rolled back onto the shoulders (rolls / back tucks)
  // Two stills: side profile is the main one.
  // ===========================================================================
  {
    id: 'tucked_candle',
    name: 'Tucked candle',
    ...
    criteria: [
      {
        id: 'hips_over',
        label: 'Hips over shoulders',
        kind: 'segment_vs_vertical',
        segment: [LM.LEFT_SHOULDER, LM.LEFT_HIP],
        target: 0,
        tolerance: 22,
        falloff: 45,
        weight: 24,
      ...
      {
        id: 'thighs_to_eyes',
        label: 'Thighs in front of the eyes',
        kind: 'point_distance',
        pair: [LM.LEFT_KNEE, LM.LEFT_EYE],
        target: 0,
        tolerance: 0.16,
        falloff: 0.22,
        weight: 12,
      ...
      },
      {
        ...
        falloff: 0.24,
        weight: 12,
        feedbackHigh: 'Arms behind the ears.',
      },
      {
        id: 'elbows',
        label: 'Elbows straight',
        ...
        tolerance: 12,
        weight: 8,
        feedbackLow: 'Straighten the arms on the floor.',
      },
      {
        id: 'feet_together',
        label: 'Feet together',
  ...
  // ===========================================================================
  // SIDE PLANK — forearm plank, both sides. Conditioning + some twist drills.
  // Bent-knee version OK (weight on the bottom knee).
  // ===========================================================================
  {
    id: 'side_plank',
    name: 'Side plank',
    ...
    criteria: [
      ...
      {
        id: 'elbow_stacked',
        label: 'Elbow under shoulder',
        kind: 'segment_vs_vertical',
        segment: [LM.LEFT_SHOULDER, LM.LEFT_ELBOW],
        target: 0,
        tolerance: 22,
        falloff: 40,
        weight: 12,
        needsView: 'side',
        feedbackHigh: 'Stack the elbow under the shoulder.',
      },
      {
        id: 'hips',
        label: 'Hips open',
      ...
      },
      {
        ...
        falloff: 0.2,
        weight: 12,
        feedbackHigh: 'Stack one foot on the other.',
      },
      {
        id: 'knees',
        label: 'Knees (straight if you can)',
        kind: 'joint_angle',
        points: L_KNEE,
        targetMin: 95,
        targetMax: 180,
      ...
      },
      {
        ...
        label: 'Head in line',
        kind: 'segment_vs_horizontal',
        segment: [LM.LEFT_SHOULDER, LM.LEFT_EAR],
        target: 0,
        tolerance: 28,
        falloff: 45,
        weight: 8,
  ...
  // Lunge arm-position holds use LANDING lunge legs: shorter stance, back heel FLAT.
  {
    ...
    criteria: [
      ...
      LANDING_HEEL_FLAT,
      LANDING_CLOSER_STEP,
      { ...LUNGE_DIAGONAL, weight: 28 },
      {
        id: 'low_v',
        label: 'Low V arms (slightly back)',
        kind: 'joint_angle',
        points: L_SHOULDER,
        targetMin: 10,
        targetMax: 100,

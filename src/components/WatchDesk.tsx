  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-4">
      <section className="rounded-xl border border-[var(--panel-border)] bg-[var(--panel)] p-5">
        ...
        <p className="mt-2 text-sm leading-relaxed text-[var(--muted)]">
          This is a gym log, not a legal record. Login changes from this
          browser carry a gym mark so another site cannot send them. A new
          sign-in on the same email ends the last one. Session ids stay on the
          server. Roster saves stay off this list unless you turn them on —
          the gym writes that file often.
        </p>
      </section>
